...
class TemperatureInfo {
  ...
  TemperatureInfo({required this.temperature,required this.minTemp,required this.maxTemp});

  factory TemperatureInfo.fromJson(Map<String, dynamic> json) {
    final temperature = json['temp'];
    final minTemp = json['temp_min'];
    final maxTemp = json['temp_max'];
    return TemperatureInfo(temperature: temperature, minTemp: minTemp, maxTemp: maxTemp);
  }
}
